...
- default : all workflows + cheap/local activities (chunk, read_sources, manifest).
...
async def main() -> None:
    ...
    default_worker = Worker(
        ...
        activities=[read_sources, chunk_documents, read_chunk_count],
    ...
    print(f"  {DEFAULT_QUEUE}: workflows + chunk/read_sources/manifest")
